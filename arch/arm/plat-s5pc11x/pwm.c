...
int pwm_enable(struct pwm_device *pwm)
{
	...
	if (pwm->pwm_id==1)
	{
	        //s3c_gpio_cfgpin(S5PC11X_GPD0(1), S5PC11X_GPD_0_1_TOUT_1); //jihyon82.kim for victory magnetic sensor
	}
...
void pwm_disable(struct pwm_device *pwm)
{
	...
	if (pwm->pwm_id==1)
	{
	    	//gpio_direction_output(S5PC11X_GPD0(1), 0); //jihyon82.kim for victory magnetic sensor
	}
...
static int s3c_pwm_probe(struct platform_device *pdev)
{
	...
	if (id == 0) {
		...
		}*///jihyon82.kim for victory magnetic sensor
