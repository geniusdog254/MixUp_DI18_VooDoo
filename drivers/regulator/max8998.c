				...
				const struct i2c_device_id *i2c_id)
{
	...
	lpm_mode_check();
       ...
       /* T_FLASH_EN GPG2(2) to enable Tflash pwr */
       
       s3c_gpio_cfgpin(S5PC11X_GPG2(2),S3C_GPIO_OUTPUT );
       gpio_set_value(S5PC11X_GPG2(2),1);

#if 1 //20100504_inchul.. To disable the LDO5 'CAM_SENSOR_1.8V' in booting time (for victory)
  if(max8998_ldo_is_enabled_direct(MAX8998_LDO5)){
     max8998_ldo_disable_direct(MAX8998_LDO5);    
  }
#endif       
