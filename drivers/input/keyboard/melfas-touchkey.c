...
#define _3_GPIO_TOUCH_INT S5PC11X_GPJ3(3)

#undef _3_GPIO_TOUCH_EN
#define _3_GPIO_TOUCH_EN S5PC11X_GPJ1(3)
...
#define IRQ_TOUCH_INT S3C_GPIOINT(J3,3)//hojun_kim
#else
...
#ifdef CONFIG_ARIES_VER_B1
static unsigned short probe_addr[] = {13, TOUCHKEY_ADDRESS, I2C_CLIENT_END};
#else
...
//	if((HWREV == 0xE) && ((data[1] < 0x9) || (data[1] == 0xff)))
	{
