...
/*
	...
	*/
	...
	// sharpness keepers : 0x009C, 0x0FF0-0x00B4, 0x0500
	// Voodoo : replaced 
	0x0084, 0x0040, // 0x0084, 0x0040
	0x0090, 0x0000, // 0x0090, 0x0000,
	0x0094, 0x0FFF, // 0x0094, 0x0fff,
	0x0098, 0x005C, // 0x0098, 0x005C,
	0x009C, 0x0FF5, // 0x009C, 0x0ff0, // light sharpness 010->FFF
	0x00AC, 0x0007, // 0x00AC, 0x0080, // color vibrance - saturation boost
	0x00B4, 0x0500, // 0x00B4, 0x0180, // mid + shadow sharpness : FFF->?, affect first setting too
	0x00C0, 0x0400, // 0x00C0, 0x0400,
	0x00C4, 0x7200, // 0x00C4, 0x7200,
	0x00C8, 0x008D, // 0x00C8, 0x008D,
	0x00D0, 0x00C0, // 0x00D0, 0x00C0,
	END_SEQ, 0x0000, // END_SEQ, 0x0000
...
/*
	...
	// sharpness keepers : 
	// 0x009C, 0x0610 - 0x00B4, 0x0DFF - medium-light
	// 0x009C, 0x0610 - 0x00B4, 0x0A00 - medium-light

	0x0084, 0x0040, // 0x0084, 0x0040 // Gamma /Luminance boost, probably 40:standard 90:very high FA:broken // only for toolkit, no video
	0x0090, 0x0000, // 0x0090, 0x0000,
	0x0094, 0x0FFF, // 0x0094, 0x0fff,
	0x0098, 0x005C, // 0x0098, 0x005C,
	0x009C, 0x0610, // 0x009C, 0x0ff0, // light sharpness 010->FFF
	0x00AC, 0x0000, // 0x00AC, 0x0080, // color vibrance - saturation boost
	0x00B4, 0x0A00, // 0x00B4, 0x0180, // mid + shadow sharpness : FFF->?, affect first setting too
	0x00C0, 0x0400, // 0x00C0, 0x0400,  // Color+Brighness boost for video content
	0x00C4, 0x7200, // 0x00C4, 0x7200,
	0x00C8, 0x008D, // 0x00C8, 0x008D,
	0x00D0, 0x00C0, // 0x00D0, 0x00C0, // shadow boost ?
	END_SEQ, 0x0000, // END_SEQ, 0x0000
...
/*	0x0084, 0x0020,
	...
	// Voodoo : replaced by a mode with high vibrance and sharpening
	0x0084, 0x0040, // 0x0084, 0x0040
	0x0090, 0x0000, // 0x0090, 0x0000,
	0x0094, 0x0FFF, // 0x0094, 0x0fff,
	0x0098, 0x005C, // 0x0098, 0x005C,
	0x009C, 0x0FFF, // 0x009C, 0x0ff0, //
	0x00AC, 0x0220, // 0x00AC, 0x0080, //
	0x00B4, 0x0800, // 0x00B4, 0x0180, //
	0x00C0, 0x0400, // 0x00C0, 0x0400,
	0x00C4, 0x7200, // 0x00C4, 0x7200,
	0x00C8, 0x008D, // 0x00C8, 0x008D,
	0x00D0, 0x00C0, // 0x00D0, 0x00C0,
...
{
	// Voodoo : replaced by a clean mode for noisy videos
	0x0084, 0x0040, // 0x0084, 0x0040
	0x0090, 0x0000, // 0x0090, 0x0000,
	0x0094, 0x0FFF, // 0x0094, 0x0fff,
	0x0098, 0x005C, // 0x0098, 0x005C,
	0x009C, 0x0010, // 0x009C, 0x0ff0, // sharpness level: values < 10 produce a strange result
	0x00AC, 0x0000, // 0x00AC, 0x0080, // color vibrance - saturation boost
	0x00B4, 0x0000, // 0x00B4, 0x0180, // sharpness radius
	0x00C0, 0x0400, // 0x00C0, 0x0400,
	0x00C4, 0x7200, // 0x00C4, 0x7200,
	0x00C8, 0x008D, // 0x00C8, 0x008D,
	0x00D0, 0x00C0, // 0x00D0, 0x00C0,
